                ...
                Komi.channels.resolve('887362027956371507').send({
                    embeds: [
                        new MessageEmbed()
                            ...
                            .setDescription(`¡Hola **${member.user.tag}**, bienvenido(a) al soporte de **🌸 Komi Shouko 🌸** esperamos que sea de tu agrado este servidor.`)
                            .setImage("https://cdn.discordapp.com/attachments/880562658401722379/934945897295527956/komi-san-komi-shouko_1.gif")
                            .setColor("#FFCC8E")
